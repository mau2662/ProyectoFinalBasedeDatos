...
namespace ProyectoLenguajesNetCore.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_CLIENTE,NOMBRE,APELLIDO,GENERO,CORREO,DIRECCION,TELEFONO")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_CLIENTE,NOMBRE,APELLIDO,GENERO,CORREO,DIRECCION,TELEFONO")] Client client)
        {
            if (id != client.ID_CLIENTE)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ClientExists(client.ID_CLIENTE))
                    {
                        return NotFound();
                    }
                    else
